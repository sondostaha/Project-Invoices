		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				...
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}">
					<img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}">
					<img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}">
					<img src="{{URL::asset('assets/img/brand/favicon-white.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">الفواتير</span></span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">تقارير العمله</a></li>
