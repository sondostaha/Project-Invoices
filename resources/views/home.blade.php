				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  ...
						  <p class="mg-b-0">موقع اداره الفواتير</p>
						</div>
					</div>
				...
				<div class="row row-sm">
									...
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												عدد الفواتير المتاحه  {{App\Models\invoices::count()}}
											</p>
										</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">اجمالي الفواتير المدفووعه</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												 عدد الفواتير المدفوعه{{App\Models\invoices::where('value_status',1)->count()}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												عدد الفواتير الغير المدفوعه  {{App\Models\invoices::where('value_status',2)->count()}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												 عدد الفواتير المدفوعه جزئيا  {{App\Models\invoices::where('value_status',3)->count()}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
						...
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">احصايات الفواتير</h4>
									<i class="mdi mdi-dots-horizontal text-gray"></i>
								</div>
								<p class="tx-12 text-muted mb-0">
                                    جميع الاحصائيات شامله الفواتير المدفوعه و غير المدفوعه والمدفوعه جزئيا
                                </p>
							</div>
