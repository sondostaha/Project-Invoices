...
@endif
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('update.status',$invoices->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName"value="{{$invoices->invoices_number}}" name="invoices_number"
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" value="{{$invoices->due_date}}" name="due_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" value="{{$invoices->product}}" class="form-control" readonly readonly>
                                    {{$invoices->product}}
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="Rate_VAT" value="{{$invoices->rate_vat}}" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
