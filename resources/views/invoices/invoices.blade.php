						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
									...
									<a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
											...
											<a class="modal-effect btn btn-sm btn-success" href="{{ url('invoices_export') }}"
													...
													<div class="dropdown">
														...
														<div  class="dropdown-menu tx-13">
															...
															<a class="dropdown-item" href="{{URL::route('status_show',[$invoice->id])}}"><i
																class="text-success fas"> تغير حاله الدفع</a>
															...
															<a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
																data-toggle="modal" data-target="#Transfer_invoice"><i
																	class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; نقل اي الارشيف 
																</a>

															<a class="dropdown-item" href="print_invoice/{{$invoice->id}}"
																><i
																	class="text-success fas fa-print"></i>&nbsp;&nbsp;  طباعه  
																</a>
					...
					<div class="modal-content">
						...
						<form action="invoices/destroy" method="post">
							...
							<div class="modal-body">
								<p class="text-center">
									<input type="hidden" name="invoice_id" id="invoice_id" value="">
								<h6 style="color:red"> هل انت متاكد من عملية حذف الفاتوره ؟</h6>
								</p>
							</div>
